...
from deep_q_learning_model_128_64_32_package.deep_q_learning_model_128_64_32_custom_reward import DeepQLearningModel_128_64_32_custom_reward
from os import path

NUM_GAMES = 5021 - 375
NUM_TRAINING = 5000 - 375
MODEL_FILE_NAME = 'models_power_custom_reward_128_64_32_model/DeepQModel.chkpt'
REPLAY_MEMORY_FILE_NAME = 'models_power_custom_reward_128_64_32_model/replay_memory'
STATISTICS_BEST_SCORE_FILE = "models_power_custom_reward_128_64_32_model/statistics_score_best.txt"
STATISTICS_EVERY_GAME_FILE = "models_power_custom_reward_128_64_32_model/statistics_every_game.txt"
EPSILON_FILE_NAME = "models_power_custom_reward_128_64_32_model/epsilon.npy"
STATISTICS_FILE = "models_power_custom_reward_128_64_32_model/statistics_final.txt"
DO_STATISTICS = True
...
if __name__ == "__main__":
    if DO_STATISTICS:
        ...
        if IS_TRAINING:
            ...
            # Define bot
            bot = DeepQAgent(DeepQLearningModel_128_64_32_custom_reward(model_file_name=MODEL_FILE_NAME,
                                                                        replay_memory_file_name=REPLAY_MEMORY_FILE_NAME,
                                                                        epsilon_file_name=EPSILON_FILE_NAME,
                                                                        epsilon=0.05,
                                                                        max_replay_memory=16000,
