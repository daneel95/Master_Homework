...
from games.game_2048_flatten_scaled import game_2048_flatten_scaled
from deep_q_learning_model_128_32_8_package.deep_q_learning_model_128_32_8_custom_reward import DeepQLearningModel_128_32_8_custom_reward
from os import path

NUM_GAMES = 20000
NUM_TRAINING = 20000
MODEL_FILE_NAME = 'models_flatten_scaled_custom_reward_128_32_8/DeepQModel.chkpt'
REPLAY_MEMORY_FILE_NAME = 'models_flatten_scaled_custom_reward_128_32_8/replay_memory'
STATISTICS_BEST_SCORE_FILE = "models_flatten_scaled_custom_reward_128_32_8/statistics_score_best.txt"
STATISTICS_EVERY_GAME_FILE = "models_flatten_scaled_custom_reward_128_32_8/statistics_every_game.txt"
EPSILON_FILE_NAME = "models_flatten_scaled_custom_reward_128_32_8/epsilon.npy"
STATISTICS_FILE = "models_flatten_scaled_custom_reward_128_32_8/statistics_final.txt"
DO_STATISTICS = True
...
if __name__ == "__main__":
    if DO_STATISTICS:
        ...
        if IS_TRAINING:
            ...
            # Define bot
            bot = DeepQAgent(DeepQLearningModel_128_32_8_custom_reward(
            ...
            for i in range(100):
                ...
                game = game_2048_flatten_scaled(show_ui=True)
                print(game.get_board().__str__())
                while not game.is_game_over():
                    action = bot.get_action(game)
                    game.do_game_round(action)
