...
class DeepQLearningModel_128_32_8(DeepQLearningModelBase):
    def __init__(self,
    ...
    def init_model(self, state):
        ...
        self.model.add(Dense(128, input_dim=input_dimensions, activation='linear'))
        self.model.add(LeakyReLU(0.001))
        self.model.add(Dropout(rate=0.125))
