...
from games.game_2048_power_normalized_state import game_2048_power_normalized_state
from deep_q_learning_model_300_300_200_200_100_regularization_package.deep_q_learning_model_300_300_200_200_100_regularization_custom_reward import DeepQLearningModel_300_300_200_200_100_regularization_custom_reward
from os import path

NUM_GAMES = 10000 - 4920
NUM_TRAINING = 10000 - 4920
MODEL_FILE_NAME = 'models_power_normalized_custom_reward_300_300_200_200_100_regularization/DeepQModel.chkpt'
REPLAY_MEMORY_FILE_NAME = 'models_power_normalized_custom_reward_300_300_200_200_100_regularization/replay_memory'
STATISTICS_BEST_SCORE_FILE = "models_power_normalized_custom_reward_300_300_200_200_100_regularization/statistics_score_best.txt"
STATISTICS_EVERY_GAME_FILE = "models_power_normalized_custom_reward_300_300_200_200_100_regularization/statistics_every_game.txt"
EPSILON_FILE_NAME = "models_power_normalized_custom_reward_300_300_200_200_100_regularization/epsilon.npy"
STATISTICS_FILE = "models_power_normalized_custom_reward_300_300_200_200_100_regularization/statistics_final.txt"
DO_STATISTICS = True
...
if __name__ == "__main__":
    if DO_STATISTICS:
        ...
        if IS_TRAINING:
            ...
            # Define bot
            bot = DeepQAgent(DeepQLearningModel_300_300_200_200_100_regularization_custom_reward(model_file_name=MODEL_FILE_NAME,
            ...
            for i in range(100):
                ...
                game = game_2048_power_normalized_state(show_ui=True)
                print(game.get_board().__str__())
                while not game.is_game_over():
                    action = bot.get_action(game)
                    game.do_game_round(action)
