...
from games.game_2048_power_state_custom_score import game_2048_power_state_custom_score
...
NUM_GAMES = 5021 - 160 - 300
NUM_TRAINING = 5000 - 160 - 300
MODEL_FILE_NAME = 'models_power_custom_score/DeepQModel.chkpt'
REPLAY_MEMORY_FILE_NAME = 'models_power_custom_score/replay_memory'
STATISTICS_BEST_SCORE_FILE = "models_power_custom_score/statistics_score_best.txt"
STATISTICS_EVERY_GAME_FILE = "models_power_custom_score/statistics_every_game.txt"
EPSILON_FILE_NAME = "models_power_custom_score/epsilon.npy"
STATISTICS_FILE = "models_power_custom_score/statistics_final.txt"
DO_STATISTICS = True
...
if __name__ == "__main__":
    if DO_STATISTICS:
        ...
        if IS_TRAINING:
            ...
            bot = DeepQAgent(DeepQLearningModel_300_300_200_200_100_100_60_60(
            ...
            for i in range(100):
                ...
                game = game_2048_power_state_custom_score(show_ui=True)
                print(game.get_board().__str__())
                while not game.is_game_over():
                    action = bot.get_action(game)
                    game.do_game_round(action)
